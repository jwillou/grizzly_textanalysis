...
setwd("/Users/jannawilloughby/Google Drive/My Drive/Willoughby lab/projects - active/grizzly_text/")
...
fulldata = read.table("Wyoming Grizzly bear documentsV2_jrw.csv", sep=",", header=T, comment.char = "")
data = fulldata[fulldata$type!="NOTRELEVANT",]

#set variables
lowerthreshold = c(5,10,25) #words that do not appear in at least this many documents will be removed
